...
**บน Windows**
```bat
scripts\install.bat    :: ติดตั้งครั้งแรก — สร้าง .venv แล้วลง dependencies
scripts\run.bat        :: เปิดโปรแกรม
```
...
> ถ้าสคริปต์ `.sh` รันไม่ได้เพราะสิทธิ์ ให้สั่ง `chmod +x scripts/*.sh` หนึ่งครั้งก่อน
